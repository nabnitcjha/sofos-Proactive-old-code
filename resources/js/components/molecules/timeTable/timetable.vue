<template>
  <div class="row card-common-design">
    <div class="col-lg-12 detail-card">
      <div class="card mb-4 timetable-info col-lg-12">
        <div
          class="
            card-header
            py-3
        ...
        >
          ...
          <button
                ...
                @click="goBack"
                v-if="!studentCalendarDetail && !hideRepeat"
              >
                Back
              </button>
        </div>
          ...
          <form>
            ...
            <div class="form-group col-sm-6 col-lg-4">
              ...
              <input
                v-model="topic"
                type="text"
                class="form-control input-custom-height"
                id="topicName"
                placeholder="topic"
              />
            </div>
            ...
            <div class="form-group col-sm-6 col-lg-4" v-if="allowAddStudent">
             ...
             <div class="form-group col-sm-6 col-lg-4 calendar-select-student" v-if="allowAddTeacher">
            ...
            <div class="form-group col-sm-12 col-lg-12" v-if="allowAddTeacher">
              <div
                class="student-dlt"
            ...
            <div class="form-group col-sm-6 col-lg-4 date-design input-custom-height">
            ...
            <div
              class="form-group col-sm-12 col-lg-12 custom-checkbox session-custom-width"
...
export default {
  ...
  watch: {
    currentEvent: function (val, oldVal) {
      this.currentTimetableId = val.id;
      this.getData();
    }
   },
  props: {
  ...
  mounted() {
    if (this.$route.name=='studentCalendarDetail') {
      this.getCurrentTimetableId();
      this.hideRepeat = true;
      this.selectedStudent.push({'id':this.$route.params.student_id})
      this.allowAddTeacher=false;
      this.allowAddStudent=true;
      this.studentCalendarDetail = true;
      // this.getData();
    }
    if (this.$route.name=='teacherCalendarDetail') {
      this.getCurrentTimetableId();
      this.hideRepeat = true;
      this.selectedTeacher.push({'id':this.$route.params.teacher_id});
      this.currentTeacherId = this.$route.params.teacher_id;
      this.allowAddTeacher=true;
      this.studentCalendarDetail = false;
      // this.getData();
    }
    if (this.$route.name=='addStudentClassSchedule') {
      this.selectedStudent.push({'id':this.$route.params.student_id})
      this.allowAddStudent=true;
      this.studentCalendarDetail = false;
    }
    if (this.$route.name=='addTeacherClassSchedule') {
      this.selectedTeacher.push({'id':this.$route.params.student_id});
      this.currentTeacherId = this.$route.params.student_id;
      this.allowAddTeacher=true;
      this.studentCalendarDetail = false;
    }
    this.getSubjects(1);
