          ...
          <div class="card">
            <div class="row g-0">
             ...
             <a class="list-group-item list-group-item-action border-0" 
                @click.stop="openChat(admin,'teacher-admin')"
                >
                ...
                <a class="list-group-item list-group-item-action border-0" 
               @click.stop="openChat(parent,'teacher-parent')"
              ...
              :key="index"
                >
                  ...
                  <a class="list-group-item list-group-item-action border-0" 
               @click.stop="openChat(student,'teacher-student')"
                  ...
                  <div class="d-flex align-items-center py-1">
                    ...
                    <div class="flex-grow-1 pl-3 friend-name">
                      <strong>{{ friendName }}</strong>
                       <span
                class="teacher-type"
                >{{ currentUserType == 'teacher-admin' ?'admin': currentUserType == 'teacher-parent'?'parent':'student'}}</span
              >
    ...
    <div class="col-lg-3 detail-card change-password-card">
      <div class="card mb-4 col-12">
        <div
          ...
          "
        >
          <h6 class="m-0 font-weight-bold text-primary">Parent and Students</h6>
        </div>
...
export default {
  ...
  methods: {
    ...
    getStudentAndParentList() {
      
        let formData = {};
        formData['teacher_id'] = this.user.teacher.id;
      axios.post("/api/getStudentAndParentList",formData).then((response) => { 
     ...
     sendMessage() { 
            ...
            formData["mode"] = this.currentUserType;
            axios
