                ...
                <div class="px-4 d-none d-md-block">
                  <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                      <input type="text" class="form-control my-3" placeholder="USER LIST" disabled>
                    </div>
                  </div>
                </div>
      
                <a class="list-group-item list-group-item-action border-0" 
                @click.stop="openChat(user,type=user.student != null ? 'Student' : user.teacher !=null ? 'Teacher':'Parent')"
                  v-for="(user, index) in userLists"
                  :key="index"
                >
                  <!-- <div class="badge bg-success float-right">5</div> -->
                  <div class="d-flex align-items-start">
                    <img   :src="user.user_image == 0 ? require('./profile.jpg').default:$root.getMedia(user.user_image)"
                ...
                <div class="py-2 px-4 border-bottom d-none d-lg-block">
                  <div class="d-flex align-items-center py-1">
                    ...
                    <div class="flex-grow-1 pl-3 friend-name">
                      ...
                      <span
                v-bind:class="['', currentType == 'Student' ? 'student-type' : currentType =='Teacher' ? 'teacher-type':'parent-type']" 
                >{{ currentType }}</span
              >
                ...
                :key="index"
                    >
                      <div>
                        <img  :src="message.user.user_image == 0 ? require('./profile.jpg').default:$root.getMedia(message.user.user_image)" class="rounded-circle mr-1" alt="Chris Wood" width="40" height="40">
      ...
      <div class="card mb-4 col-12">
        ...
        <div class="card-body chat-left-card">
          <form class="user-list">
            ...
            >
              <span
                v-bind:class="['', user.student != null ? 'student-type' : user.teacher !=null ? 'teacher-type':'parent-type']" 
                >{{ user.student != null ? 'student' : user.teacher !=null ? 'teacher':'parent' }}</span
              >
              <div class="user-name">
                {{ user.first_name }}{{' '}}{{ user.last_name }}
              </div>
          ...
          <div class="form-group col-sm-6 col-lg-12 chat-body">
            <ul class="chat">
              ...
              >
                <div class="chat-body">
                  <div class="header">
                    <strong class="primary-font" v-if="message.user.id==1">
                      {{ message.user.name }}
                    </strong>
...
export default {
  ...
  methods: {
    openChat(user,type) {
      ...
      if (user.parent!=null) {
        this.friendId = user.parent.user_id;
      }
      if (user.teacher!=null) {
        this.friendId = user.teacher.user_id;
      }
      if (user.student!=null) {
        this.friendId = user.student.user_id;
      }
